...
function Loader() {
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-slate-300/20 backdrop-blur-sm">
      {/* <div className={`${styles.loader}  text-stone-950`}></div>; */}
        ...
        >
          <g id={styles.pizza}>
            ...
            <g id={styles.slice5}>
              ...
              <g id={styles.pepperoni_2}>
                <circle cx="82" cy="56" r="6" fill="#F12424"></circle>
                <circle cx="82" cy="56" r="6" fill="#F12424"></circle>
              </g>
              <g id={styles.mushroom_2}>
                <path
            ...
            <g id={styles.slice2}>
              ...
              <g id={styles.pepperoni_4}>
                <circle cx="78" cy="103" r="6" fill="#F12424"></circle>
                <circle cx="78" cy="103" r="6" fill="#F12424"></circle>
              </g>
              <g id={styles.mushroom_3}>
                <path
            ...
            <g id={styles.slice4}>
              ...
              <g id={styles.pepperoni_5}>
                <circle cx="64" cy="70" r="6" fill="#F12424"></circle>
                <circle cx="64" cy="70" r="6" fill="#F12424"></circle>
              </g>
              <g id={styles.mushroom_4}>
                <path
            ...
            <g id={styles.slice3}>
              ...
              <g id={styles.pepperoni_6}>
                <circle cx="42" cy="99" r="6" fill="#F12424"></circle>
                <circle cx="42" cy="99" r="6" fill="#F12424"></circle>
              </g>
              <g id={styles.mushroom_5}>
                <path
